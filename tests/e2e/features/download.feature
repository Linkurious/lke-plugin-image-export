...
Feature: Download
  ...
  Examples:
    | name                | outputFormat | format    | drag   | size | textVisible | collisionRemoval |
    | full-size-1-svg.png |     svg      | Full size | false  | 200% |  true       |   false          |
    | square-1-svg.png    |     svg      |  Square   | false  | 50%  |  true       |   true           |
    | full-size-2-svg.png |     svg      | Full size | true   | 50%  |  true       |   true           |
    | square-2-svg.png    |     svg      |  Square   | true   | 200% |  true       |   false          |
    | square-3-svg.png    |     svg      |  Square   | false  | 100% |  false      |   true           |
